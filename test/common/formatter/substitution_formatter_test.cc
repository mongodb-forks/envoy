...
TEST(SubstitutionFormatterTest, ProxyProtocolTlvsFormatter) {
  ...
  {
    EXPECT_THROW_WITH_MESSAGE(SubstitutionFormatParser::parse("%PROXY_PROTOCOL_TLVS()%").IgnoreError(),
  ...
  {
    EXPECT_THROW_WITH_MESSAGE(
        SubstitutionFormatParser::parse("%PROXY_PROTOCOL_TLVS(INVALID_TLV_TYPE)%").IgnoreError(), EnvoyException,
  ...
  {
    EXPECT_THROW_WITH_MESSAGE(SubstitutionFormatParser::parse("%PROXY_PROTOCOL_TLVS(3000000000)%").IgnoreError(),
                              EnvoyException,
  ...
  {
    EXPECT_THROW_WITH_MESSAGE(SubstitutionFormatParser::parse("%PROXY_PROTOCOL_TLVS(300)%").IgnoreError(),
                              EnvoyException,
